...
export const FLAG = swisseph.SEFLG_SPEED | swisseph.SEFLG_MOSEPH;
...
export const RASHI_REVERSE_MAP = {
  0: "Ar",
  1: "Ta",
  2: "Ge",
  3: "Cn",
 ...
 */
export const rashi_calc = (rashi, num) => {
...
export const NAKSHATRA_ANIMALS = {
  Ashwini: "Horse",
  Bharani: "Elephant",
  Krittika: "Sheep",
  Rohini: "Serpent",
...
export const NAKSHATRA_ANIMAL_SCORE = {
  Horse: {
    Horse: 4,
  },
  Elephant: {
...
export const GOOD_HOUSES = [1, 2, 3, 4, 5, 7, 9, 10, 11];
export const BAD_HOUSES = [6, 8, 12];
...
export const GOOD_CONNECTION_TYPES = [1, 3, 5, 7, 9, 11];
export const BAD_CONNECTION_TYPES = [2, 4, 6, 8, 10, 12];

export const MANGLIK = [1, 4, 7, 8, 12];

export { swisseph };

export const NAVAMSA_DIVISIONS = [
  3.3329,
  6.666,
  9.999,
  13.3329,
...
export const SKEWED_REVERSE_RASHI_MAP = {
  1: "Ar",
  2: "Ta",
  3: "Ge",
  4: "Cn",
